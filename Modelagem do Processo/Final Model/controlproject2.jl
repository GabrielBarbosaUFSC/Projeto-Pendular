...
#(2.279340119435931e-6s) / (0.00033256402574613996 + 2.2767175819038683e-6s - 1.7962251849678757e-8(s^3) - 7.625553066001966e-6(s^2))
a0θ = 0
...
#(1.2832316353076082e-6 - 2.202642566003433e-8(s^2)) / (1.0800156075959698e-6s + 7.39373573863731e-9(s^2) - 5.833316547602505e-11(s^4) - 2.4764303082258486e-8(s^3))
a0Φ = 1.2832316353076082e-6 
a1Φ = 0
...
#(0.0032475418986550007(s^2)) / (0.5629838321913844 - 0.009663509834366105(s^2))
a0Hn = 0
a1Hn = 0
